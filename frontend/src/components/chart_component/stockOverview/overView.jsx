        ...
        <>
          ...
          <div className="stock-info-grid">
            ...
            <div className="stock-info-column" >
              <p><span className='ibm-plex-sans-heavy-ov'>EBITDA:</span> ${latestData?.EBITDA ? latestData.EBITDA.toLocaleString() : "No Data"}</p>
              <p><span className='ibm-plex-sans-heavy-ov'>Operating Income:</span> ${latestData["Operating Income"]?.toLocaleString() || "No Data"}</p>
              <p><span className='ibm-plex-sans-heavy-ov'>Total Revenue:</span> ${latestData["Total Revenue"]?.toLocaleString() || "No Data"}</p>
              <p><span className='ibm-plex-sans-heavy-ov'>Net Income:</span> ${latestData["Net Income"]?.toLocaleString() || "No Data"}</p>
            </div>
